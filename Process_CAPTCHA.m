% This is a matlab file that processes a captcha created by
% Make_Captcha.m
% All you need to do is input the filename thay you want to break in line 8
% The final output will be a string of characters that are present in the
% Captcha

% Load our captcha (tif file) and convert to grayscale
captcha=rgb2gray(imread('Example_Captcha_18.tif'));
...
% Create a scatter plot of points vector
figure;
...
% Create a plot of Captchavec, which is now rotated
figure;
scatter(Captchavec(:,2),Captchavec(:,1)); 
...
% that we can get rid of some black space
...
% Display our string in a message box
h = msgbox(string,'The CAPTCHA has been broken');
